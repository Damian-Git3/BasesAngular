...
export class Convert {
  public static toWelcome(json: string): GiphyData {
    return cast(JSON.parse(json), r('Welcome'));
  }

  public static welcomeToJson(value: GiphyData): string {
...
const typeMap: any = {
  ...
  Datum: o(
    [
      ...
      { json: 'emoji_group_id', js: 'emoji_group_id', typ: 0 },
      { json: 'variation', js: 'variation', typ: r('Variation') },
      { json: 'variation_count', js: 'variation_count', typ: 0 },
      {
  ...
  Analytics: o(
    [
      ...
      { json: 'onstart', js: 'onstart', typ: r('Onclick') },
    ],
    false
  ),
  ...
  Pagination: o(
    [
      ...
      { json: 'next_cursor', js: 'next_cursor', typ: 0 },
    ],
    false
  ),
  Rating: ['g'],
